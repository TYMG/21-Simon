...
export class GameService {
    ...
    private patternSubscription;
    private levelSubject;
    private levelSubscription;
    private gameSubject;
    private gameSubscription;

    constructor(private patternService: PatternService, private timerService: TimerService) {
    ...
    startGame() {
        ...
        */
        ...
        this.gameSubject = new BehaviorSubject<boolean>(false);
    ...
    nextLevel() {
        ...
        this.levelSubject = new BehaviorSubject<boolean>(false);
        ...
        let updatePatternPromise = this.patternService.updatePattern.bind(this.patternService, that.pattern);
            ...
            let displayPatternPromise = (pattern) =>
                new Promise(resolve => {
                    ...
                    let patternDisplaySubject = new BehaviorSubject<number>(0);
    ...
    *
    */
    displayPattern(index, prevColor, pattern: Array<Color>, patternDisplaySubscription) {
        //check values
